                ...
                <div class="p-6">
                    <form wire:submit="saveProfile" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-1.5">
                            ...
                            <input wire:model="firstName" class="w-full rounded-lg border-slate-300 text-slate-900 focus:ring-[#E3655B] focus:border-[#E3655B] bg-slate-50" id="firstName" type="text">
                            @error('firstName') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div class="space-y-1.5">
                            <label class="text-xs font-semibold text-slate-500 uppercase tracking-wide" for="lastName">Last Name</label>
                            <input wire:model="lastName" class="w-full rounded-lg border-slate-300 text-slate-900 focus:ring-[#E3655B] focus:border-[#E3655B] bg-slate-50" id="lastName" type="text">
                        ...
                        <div class="space-y-1.5 md:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input wire:model="email" class="w-full pl-10 rounded-lg border-slate-300 text-slate-900 focus:ring-[#E3655B] focus:border-[#E3655B] bg-slate-50" id="email" type="email" disabled>
                            </div>
                        ...
                        <div class="space-y-1.5 md:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input wire:model="phone" class="w-full pl-10 rounded-lg border-slate-300 text-slate-900 focus:ring-[#E3655B] focus:border-[#E3655B] bg-slate-50" id="phone" type="tel" placeholder="+234 800 123 4567">
                            </div>
