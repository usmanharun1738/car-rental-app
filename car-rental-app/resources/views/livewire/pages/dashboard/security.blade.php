                ...
                <div class="p-6">
                    <form wire:submit="updatePassword" class="flex flex-col gap-5">
                        <div>
                            ...
                            <input wire:model="currentPassword" type="password" class="w-full py-3 px-4 rounded-lg border border-slate-200 shadow-sm focus:outline-none focus:ring-1 focus:ring-[#E3655B] focus:border-[#E3655B]" placeholder="••••••••">
                            @error('currentPassword') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-1">New Password</label>
                                <input wire:model="newPassword" type="password" class="w-full py-3 px-4 rounded-lg border border-slate-200 shadow-sm focus:outline-none focus:ring-1 focus:ring-[#E3655B] focus:border-[#E3655B]" placeholder="••••••••">
                                @error('newPassword') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-1">Confirm New Password</label>
                                <input wire:model="newPassword_confirmation" type="password" class="w-full py-3 px-4 rounded-lg border border-slate-200 shadow-sm focus:outline-none focus:ring-1 focus:ring-[#E3655B] focus:border-[#E3655B]" placeholder="••••••••">
                            </div>
                        </div>
