                        ...
                        <form wire:submit="saveLicense" class="flex flex-col gap-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-1.5">
                                    ...
                                    <input wire:model="licenseNumber" type="text" class="w-full rounded-lg border-slate-300 focus:ring-[#E3655B] focus:border-[#E3655B] bg-slate-50" placeholder="e.g., ABJ123456789">
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input wire:model="fullName" type="text" class="w-full rounded-lg border-slate-300 focus:ring-[#E3655B] focus:border-[#E3655B] bg-slate-50">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                                <div class="space-y-1.5">
                                    ...
                                    <input wire:model="dateOfBirth" type="date" class="w-full rounded-lg border-slate-300 focus:ring-[#E3655B] focus:border-[#E3655B] bg-slate-50">
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <select wire:model="licenseClass" class="w-full rounded-lg border-slate-300 focus:ring-[#E3655B] focus:border-[#E3655B] bg-slate-50">
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <select wire:model="sex" class="w-full rounded-lg border-slate-300 focus:ring-[#E3655B] focus:border-[#E3655B] bg-slate-50">
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <select wire:model="stateOfIssue" class="w-full rounded-lg border-slate-300 focus:ring-[#E3655B] focus:border-[#E3655B] bg-slate-50">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-1.5">
                                    ...
                                    <input wire:model="issueDate" type="date" class="w-full rounded-lg border-slate-300 focus:ring-[#E3655B] focus:border-[#E3655B] bg-slate-50">
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input wire:model="expiryDate" type="date" class="w-full rounded-lg border-slate-300 focus:ring-[#E3655B] focus:border-[#E3655B] bg-slate-50">
